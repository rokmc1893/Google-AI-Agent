# Google AI Agent — Ruby Kiwi Web

React(Vite) + TypeScript + Tailwind CSS v4 기반의 **루비 키위(Ruby Kiwi)** 랜딩 페이지 프로젝트입니다.
...
> 각 주차 끝날 때 커밋 메시지에 `1차 과제`, `2차 과제`처럼 **차수 제목**을 넣어 추적하기 쉽게 합니다.
